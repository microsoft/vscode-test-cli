...
export interface IBaseTestConfiguration {
  ...
  /**
   * Defines additional dependent extensions to install during tests.  Specify
   * extension IDs for the marketplace as name, name@version, or name@prerelease for
   * the latest prerelease
   */
  dependentExtensions?: string | readonly string[];
